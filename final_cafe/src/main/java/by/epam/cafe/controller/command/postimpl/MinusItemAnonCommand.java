...
public class MinusItemAnonCommand extends by.epam.cafe.controller.command.Command {

    private static final Logger log = LogManager.getLogger(MinusItemAnonCommand.class);
