...
public class MinusProductOperator extends by.epam.cafe.controller.command.Command {

    private static final Logger log = LogManager.getLogger(MinusProductOperator.class);
