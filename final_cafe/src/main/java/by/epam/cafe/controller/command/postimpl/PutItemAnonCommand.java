...
public class PutItemAnonCommand extends by.epam.cafe.controller.command.Command {

    private static final Logger log = LogManager.getLogger(PutItemAnonCommand.class);
