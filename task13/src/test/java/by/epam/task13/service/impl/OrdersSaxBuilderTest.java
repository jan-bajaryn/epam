...
//    }
    ...
    public void testOrders() {
        ...
        ordersSaxBuilder.buildListOrders("D:\\Programming\\epam\\epam\\task13\\src\\main\\resources\\totest\\orders.xml");
        assertEquals(ordersSaxBuilder.getOrders(), list);
    }
    ...
    public void testNull() throws IllegalArgumentException {
        ...
        ordersSaxBuilder.buildListOrders(null);
        assertEquals(new ArrayList<>(), ordersSaxBuilder.getOrders());
    }

    @Test(expectedExceptions = NullPointerException.class)
    public void negative() throws NullPointerException {
        OrdersSaxBuilder ordersSaxBuilder = new OrdersSaxBuilder();

        ordersSaxBuilder.buildListOrders("D:\\Programming\\epam\\epam\\task13\\src\\main\\resources\\temp.xml");
        assertEquals(new ArrayList<>(), ordersSaxBuilder.getOrders());
    }
